  ...
  const bookmarkItems: BookmarkItem[] = [
    {
      ...
      desc: "Generate blog/article with any genre that you have",
      icon: "📝",
    },
    {
      type: "category",
      section: "category",
      title: "Song/Lyrics",
      desc: "Generate lyrics or sound-related content",
      icon: "🎵",
    },
    {
      type: "category",
      section: "category",
      title: "Movie Script",
      desc: "Generate the script for making a movie",
      icon: "🎬",
    },
    {
      type: "category",
    ...
    },
    {
      ...
      title: "Superherous Articles",
      desc: "Of course I'll be delighted to help you with more beautiful articles",
      icon: "🦸‍♂️",
      date: "24 Aug 2023",
    },
    {
      type: "conversation",
      section: "conversation",
      title: "Movie and Series Storyteller",
      desc: "Of course I'll be delighted to help you with more beautiful stories",
      icon: "🎬",
      date: "24 Aug 2023",
    },
    {
    ...
    },
    {
      ...
      title: "Create a Song",
      desc: "Of course I'll be delighted to help you with more",
      icon: "🎵",
      date: "24 Aug 2023",
    },
  ];
